...
class Leaderboard(object):
    ...
    def draw(self, win):
        ...
        for i, score in enumerate(scores):
            ...
            win.blit(rank, (self.x + 10, self.y + i*self.HEIGHT_ENTRY + 10 + self.HEIGHT_ENTRY/2 - rank.get_height()/2))
            ...
            win.blit(score, (self.x - name.get_width()/2 + self.WIDTH/2, self.y + i*self.HEIGHT_ENTRY + 50))
